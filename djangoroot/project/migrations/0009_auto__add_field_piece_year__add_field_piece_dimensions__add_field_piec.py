...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_piece', 'year',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'Piece.dimensions'
        db.add_column(u'project_piece', 'dimensions',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Piece.medium'
        db.add_column(u'project_piece', 'medium',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'project_piece', 'year')

        # Deleting field 'Piece.dimensions'
        db.delete_column(u'project_piece', 'dimensions')

        # Deleting field 'Piece.medium'
        db.delete_column(u'project_piece', 'medium')
