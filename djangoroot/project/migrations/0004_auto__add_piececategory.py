...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PieceCategory'
        db.create_table(u'project_piececategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('color', self.gf('colorfield.fields.ColorField')(max_length=10)),
        ))
        db.send_create_signal(u'project', ['PieceCategory'])


    def backwards(self, orm):
        # Deleting model 'PieceCategory'
        db.delete_table(u'project_piececategory')
