...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PieceCategory.color'
        db.alter_column(u'project_piececategory', 'color', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'PieceCategory.name'
        db.alter_column(u'project_piececategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PieceCategory.color'
        db.alter_column(u'project_piececategory', 'color', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PieceCategory.name'
        db.alter_column(u'project_piececategory', 'name', self.gf('django.db.models.fields.TextField')())
